...
class VideoAuditState(TypedDict):
    ...
    # --- AGENTIC STATE EXTENSION ---
    # Tracks the conversation history between agents.
    messages: Annotated[List[Any], operator.add]
    
    # Stores the raw research data from the Researcher Agent.
    research_notes: Optional[str]

    # Stores the Policy Expert's interpretation of rules.
